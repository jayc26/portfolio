...
<?php }?>
        ...
        <section style="align-content: center;align-self:center; margin-left: 20px">
            ...
            <input type="text" style="float: left; margin-left: 40px" name="in" value="{{$wd->institution_name}}" required/>
            <div>
            ...
            <option value="{{$wd->end_month}}" selected>{{$wd->start_month}}</option>
            <option value="-----" disabled>-----</option>
            <option value="Jan">Jan</option>
            <option value="Feb">Feb</option>
            <option value="Mar">Mar</option>
            ...
            <input type="text" style="float: left;margin-left: 80px" name="type" value="{{$wd->type}}" required/>
            <div>
            ...
            <input type="text" style="float: left;margin-left: 68px" name="d" value="{{$wd->degree}}" required/>
            <div>
                                                <span class="help-block" style="color:red;font-size:small" id="cperr" name="cperr"><?php echo $d_err; ?></span>
																								</div>
            <br>
            <label style="float: left">Description</label>
            <textarea name="des" value="{{$wd->d_name}}" style="float:left; margin-left:85px">{{$wd->d_name}}</textarea>
            <div>
