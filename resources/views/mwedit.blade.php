...
<?php }?>
        ...
        <section style="align-content: center;align-self:center; margin-left: 20px">
            ...
            <form method="post" action="/mwedit/post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="box">
            ...
            <input type="hidden" name="eid" value="{{$pm->pid}}" />
            <label style="float: left">Project Name</label>
            <input type="text" style="float: left; margin-left: 40px" name="pn" value="{{$pm->pname}}" required/>
            <div>
            ...
            <option value="{{$pm->category}}" selected>{{$pm->category}}</option>
            ...
            <input type="text" style="float: left; margin-left: 0px" name="d" value="{{$pm->description}}" required/>
            <div>
            ...
            <a href="#" style="float: right; margin-right:225px"><div> <button id="btn2" type="submit" name="edit">Edit </button></div></a> <!-- End Btn2 -->
