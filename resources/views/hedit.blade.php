...
<?php }?>
        ...
        <section style="align-content: center;align-self:center; margin-left: 20px">
            ...
            <form method="post" action="/hedit" enctype="multipart/form-data">
            ...
            <input type="hidden" name="eid" value="{{$pm->jid}}" />
            <label style="float: left">Job Position</label>
            <input type="text" style="float: left; margin-left: 40px" name="jp" value="{{$pm->job_profile}}" required/>
            <div>
                                                <span class="help-block" style="color:red;font-size:small" id="fnerr" name="jperr"><?php echo $jp_err; ?></span>
																								</div>
            <br>
            <label style="float: left;margin-left: 40px">Rate  $</label>
            <input type="number" style="float: left; margin-left: 40px" name="r" value="{{$pm->rate}}" required/>
            <div>
                                                <span class="help-block" style="color:red;font-size:small" id="fnerr" name="rerr"><?php echo $r_err; ?></span>
																								</div>
            <br>
            @foreach($pe as $pn)
            <label style="float: left">Attributes</label>
            <input type="text" style="float: left;margin-left: 50px" name="at[]" value="{{$pn->pd}}" required/>
            <div>
            ...
            <label style="float: left;margin-left: 40px">{{$ip->img}}</label>
            <br>
